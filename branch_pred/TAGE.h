...
#define NHIST 8		// 15 tagged tables + 1 bimodal table
//#define LOGB 15			// log of number of entries in bimodal predictor
#define LOGB 9			// log of number of entries in bimodal predictor
//int LOGB;
...
#define LOGG LOGB 		// initial definition was with 2K entries per tagged tables
//const int LOGG = 4;
...
int m[NHIST + 1] =		{0, 3, 8, 12, 17, 33, 35, 67, 97};
//int m[NHIST + 1]; 
//int m[NHIST+1]={0, 0, 10, 16, 27, 44, 60, 96, 109, 219, 449, 487, 714, 1313, 2146, 3881};

#ifndef INITHISLENGTH
#define MINHIST 2		// shortest history length
#define MAXHIST 800		// longest history length
#endif
...
#define CWIDTH 4		// predictor counter width on the tagged tables
...
class predictor
{
/*********modified variables from before the class******/
private:
...
test=predict_brcond ( addr, IS_BR_CONDITIONAL );

if(test==tk){hit=true;}

FetchHistoryUpdate ( addr, IS_BR_CONDITIONAL ,tk,1);

update_brcond ( addr, IS_BR_CONDITIONAL ,tk,1);
return hit;
}
